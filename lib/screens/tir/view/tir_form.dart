...
import 'package:prestapp/screens/tir/services/calcular_tir.dart'; // Asegúrate de que la ruta sea correcta según tu estructura de carpetas
...
class _TIRViewState extends State<TIRView> {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      setState(() {
        if (_metodoSeleccionado == 'Calcular TIR') {
          ...
          _resultadoTIR = _tirCalculator.calcularTIRPruebaError(
            flujos,
            inversionInicial,
          );
        }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Calculadora de TIR')),
      body: Padding(
